...
import { withDispatch, useSelect, withSelect } from "@wordpress/data";
...
const TypographySettings = (props) => {
	const { attributes, setAttributes, saveBlockTypography, isDisabled } = props;
				...
				>
					...
					{fontWeightOptions() && fontWeightOptions().length > 1 ? (
						<SelectControl
							...
							value={
								typeof editorskit_typography.weight !== "undefined"
									? editorskit_typography.weight
									: ""
							}
